/* autostart.c generated by valac 0.24.0, the Vala compiler
...
static void _____lambda3__gtk_toggle_button_toggled (GtkToggleButton* _sender, gpointer self);
...
void ldefault_apps_manual_autostart_init (GtkBuilder* builder) {
	...
	if (_tmp4_) {
		...
		while (TRUE) {
			...
			g_signal_connect_data ((GtkToggleButton*) _tmp35_, "toggled", (GCallback) _____lambda3__gtk_toggle_button_toggled, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
			_tmp36_ = hbox;
			...
			button = _tmp38_;
			_tmp39_ = button;
			g_signal_connect_data (_tmp39_, "clicked", (GCallback) _____lambda4__gtk_button_clicked, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
			_tmp40_ = hbox;
			_tmp41_ = button;
		...
		_tmp55_ = add_button;
		g_signal_connect_data (_tmp55_, "clicked", (GCallback) ____lambda5__gtk_button_clicked, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
		_tmp56_ = auto_vbox;
