/* process.c generated by valac 0.24.0, the Vala compiler
...
static void ___lambda3_ (GPid pid, gint status);
...
void lxsession_lxsession_spawn_command_line_async (const gchar* command_line) {
	...
	_command_size_ = command_length1;
	{
		...
		g_child_watch_add_full (G_PRIORITY_DEFAULT_IDLE, child_pid, ____lambda3__gchild_watch_func, NULL, NULL);
		spawn_env = (_vala_array_free (spawn_env, spawn_env_length1, (GDestroyNotify) g_free), NULL);
	}
	goto __finally16;
